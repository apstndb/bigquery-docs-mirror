---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/beta/bq/migration-workflows/delete
uri: https://docs.cloud.google.com/sdk/gcloud/reference/beta/bq/migration-workflows/delete
title: gcloud beta bq migration-workflows delete
...
`gcloud beta bq migration-workflows delete` ( `  WORKFLOW  ` : `  --location  ` = `  LOCATION  ` ) \[ `  --endpoint-mode  ` = `  ENDPOINT_MODE  ` \] \[ `  GCLOUD_WIDE_FLAG …  ` \]
...
To delete a migration workflow `projects/123/locations/eu/workflows/1234` , run:
    ...
    gcloud beta bq migration-workflows delete projects/123/locations/eu/workflows/1234
