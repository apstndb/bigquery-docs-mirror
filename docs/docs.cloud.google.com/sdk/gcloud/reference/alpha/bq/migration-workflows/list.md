---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/alpha/bq/migration-workflows/list
uri: https://docs.cloud.google.com/sdk/gcloud/reference/alpha/bq/migration-workflows/list
title: gcloud alpha bq migration-workflows list
...
gcloud alpha bq migration-workflows list - list migration workflows

SYNOPSIS

`gcloud alpha bq migration-workflows list` `  --location  ` = `  LOCATION  ` \[ `  --endpoint-mode  ` = `  ENDPOINT_MODE  ` \] \[ `  --filter  ` = `  EXPRESSION  ` \] \[ `  --limit  ` = `  LIMIT  ` \] \[ `  --page-size  ` = `  PAGE_SIZE  ` \] \[ `  --sort-by  ` =\[ `  FIELD  ` , …\]\] \[ `  --uri  ` \] \[ `  GCLOUD_WIDE_FLAG …  ` \]
...
To list all migration workflows in location `EU` , run:
    ...
    gcloud alpha bq migration-workflows list --location=eu
