---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/bq/migration-workflows/create
uri: https://docs.cloud.google.com/sdk/gcloud/reference/bq/migration-workflows/create
title: gcloud bq migration-workflows create
