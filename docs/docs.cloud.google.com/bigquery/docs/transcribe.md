---
name: documents/docs.cloud.google.com/bigquery/docs/transcribe
uri: https://docs.cloud.google.com/bigquery/docs/transcribe
title: Transcribe audio files with the ML.TRANSCRIBE function
