---
name: documents/docs.cloud.google.com/bigquery/docs/elt-tutorial-marketing
uri: https://docs.cloud.google.com/bigquery/docs/elt-tutorial-marketing
title: Build ELT pipeline for marketing analytics data
