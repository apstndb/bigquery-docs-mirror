---
name: documents/docs.cloud.google.com/bigquery/docs/information-schema-routine-options
uri: https://docs.cloud.google.com/bigquery/docs/information-schema-routine-options
title: ROUTINE_OPTIONS view
