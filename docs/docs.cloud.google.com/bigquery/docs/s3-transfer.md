---
name: documents/docs.cloud.google.com/bigquery/docs/s3-transfer
uri: https://docs.cloud.google.com/bigquery/docs/s3-transfer
title: Load Amazon S3 data into BigQuery
