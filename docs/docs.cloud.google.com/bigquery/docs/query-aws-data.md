...
When you [query a BigLake table](https://docs.cloud.google.com/bigquery/docs/query-aws-data#query-biglake-table) that references external cloud data, you can view the query results displayed in the Google Cloud console.
