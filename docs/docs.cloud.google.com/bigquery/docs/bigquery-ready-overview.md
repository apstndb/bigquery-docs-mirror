---
name: documents/docs.cloud.google.com/bigquery/docs/bigquery-ready-overview
uri: https://docs.cloud.google.com/bigquery/docs/bigquery-ready-overview
title: Google Cloud Ready - BigQuery
...
When partners sign up for this initiative, Google Cloud teams test the quality of their BigQuery integration. Partners can then work on addressing any identified gaps or areas for improvement. Once the partner integration is validated, we recognize the partner with the designation ***Google Cloud Ready - BigQuery*** .

The program benefits partners by providing a comprehensive review of their software at no charge to them to ensure that they are following BigQuery best practices and identifying areas for improvement.

The following is a list of the benefits offered to participating ISVs :
