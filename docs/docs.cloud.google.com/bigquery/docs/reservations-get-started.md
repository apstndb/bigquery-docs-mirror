---
name: documents/docs.cloud.google.com/bigquery/docs/reservations-get-started
uri: https://docs.cloud.google.com/bigquery/docs/reservations-get-started
...
6.  In the **Edition** list, select **Standard** . For more information, see [Understand BigQuery editions](https://docs.cloud.google.com/bigquery/docs/editions-intro) .
...
To learn how to assign a project to a reservation using SQL or the bq tool, see [Assign a project or folder to a reservation](https://docs.cloud.google.com/bigquery/docs/reservations-assignments#assign_my_prod_project_to_prod_reservation) .
...
To learn how to delete a reservation using SQL or the bq tool, see [Delete a reservation](https://docs.cloud.google.com/bigquery/docs/reservations-tasks#delete_a_reservation) .
