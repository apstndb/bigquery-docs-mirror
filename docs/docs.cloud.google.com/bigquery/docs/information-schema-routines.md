---
name: documents/docs.cloud.google.com/bigquery/docs/information-schema-routines
uri: https://docs.cloud.google.com/bigquery/docs/information-schema-routines
title: ROUTINES view
