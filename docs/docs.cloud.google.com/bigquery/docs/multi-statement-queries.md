---
name: documents/docs.cloud.google.com/bigquery/docs/multi-statement-queries
uri: https://docs.cloud.google.com/bigquery/docs/multi-statement-queries
title: Work with multi-statement queries
