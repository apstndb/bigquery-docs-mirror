...
For more information on deleting saved queries and managing saved query history, see [Manage saved queries](https://docs.cloud.google.com/bigquery/docs/manage-saved-queries) .
