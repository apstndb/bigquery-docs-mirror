...
To learn how to turn off the SQL generation tool, see [Turn off Gemini query assistant features](https://docs.cloud.google.com/bigquery/docs/write-sql-gemini#disable-gemini-features) .
...
To learn how to turn off Gemini in BigQuery, see [Turn off Gemini in BigQuery](https://docs.cloud.google.com/bigquery/docs/gemini-set-up#turn-off) .
