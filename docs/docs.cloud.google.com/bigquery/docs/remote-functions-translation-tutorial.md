...
1.  [Create a Cloud Run functions function](https://docs.cloud.google.com/functions/docs/console-quickstart#create_a_function) with the following specifications:
