...
To learn more about certifications and security for Gemini for Google Cloud, see [certifications and security for Gemini for Google Cloud](https://docs.cloud.google.com/gemini/docs/discover/certifications) .
...
You should adhere to the following best practices to help ensure the secure and responsible use of Gemini in BigQuery:
  ...
  - Use IAM to give the least privilege necessary. For information about security best practices in BigQuery, see [Introduction to security and access controls in BigQuery](https://docs.cloud.google.com/bigquery/docs/access-control-intro) .
...
## What's next
  ...
  - Read [Setup for Gemini in BigQuery](https://docs.cloud.google.com/bigquery/docs/gemini-set-up) .
  - Read [Introduction to data governance in BigQuery](https://docs.cloud.google.com/bigquery/docs/data-governance) .
  - Read [Certifications and security for Gemini for Google Cloud](https://docs.cloud.google.com/gemini/docs/discover/certifications) .
