---
name: documents/docs.cloud.google.com/bigquery/docs/graph-modeler
uri: https://docs.cloud.google.com/bigquery/docs/graph-modeler
...
To add a node, follow these steps. Changes that you make aren't applied until you [publish your changes](https://docs.cloud.google.com/bigquery/docs/graph-modeler#publish-graph-changes) .
...
10. Click edit **Edit primary key** .
...
To edit a node, follow these steps. Changes that you make aren't applied until you [publish your changes](https://docs.cloud.google.com/bigquery/docs/graph-modeler#publish-graph-changes) .
...
8.  In the **Node window** , click edit **Edit** .

9.  In the **Edit node** panel, click edit **Edit primary key** .
...
To remove a node, follow these steps. Changes that you make aren't applied until you [publish your changes](https://docs.cloud.google.com/bigquery/docs/graph-modeler#publish-graph-changes) .
...
8.  In the **Node window** , click delete **Remove** .
...
To add an edge, follow these steps. Changes that you make aren't applied until you [publish your changes](https://docs.cloud.google.com/bigquery/docs/graph-modeler#publish-graph-changes) .
...
To edit an edge, follow these steps. Changes that you make aren't applied until you [publish your changes](https://docs.cloud.google.com/bigquery/docs/graph-modeler#publish-graph-changes) .
...
To remove an edge, follow these steps. Changes that you make aren't applied until you [publish your changes](https://docs.cloud.google.com/bigquery/docs/graph-modeler#publish-graph-changes) .
...
8.  Review the `CREATE PROPERTY GRAPH` statement in the **Publish graph** pane, and then click **Publish** .
