...
If you're new to notebooks in BigQuery, see [required permissions](https://docs.cloud.google.com/bigquery/docs/create-notebooks#required_permissions) on the Create notebooks page.
...
To open the *Introduction to notebooks in BigQuery Studio* template in notebook gallery, and to convert it to a runnable notebook, follow these steps:
...
Introduction to notebooks in BigQuery Studio contains text, SQL, visualization, and code [cells](https://docs.cloud.google.com/bigquery/docs/create-notebooks#cells) . Cells other than text cells can be run individually, or you can run all cells in order from first to last.
...
1.  In the **Query your data using SQL cells** section, hover over the SQL cell, and then click play\_circle **Run cell** .
...
2.  View the results. The query results are displayed in a DataFrame.
    ...
    > **Note:** To clear or copy the results, click more\_horiz **Code cell output actions** .

3.  In the **Visualize data** section, hover over the visualization cell, and then click play\_circle **Run cell** .
...
5.  In the **Clean the data** section, hover over the code cell, and then click play\_circle **Run cell** .
...
7.  In the **Predict values using `AI.FORECAST`** section, hover over the SQL cell, and then click play\_circle **Run cell** .
...
9.  In the **Visualize data using Python** section, hover over the code cell, and then click play\_circle **Run cell** .
...
3.  For the notebook you're deleting, click more\_vert **Open actions \> Delete** .
...
To learn more about generative AI and ML functions in BigQuery, see the [Generative AI overview](https://docs.cloud.google.com/bigquery/docs/generative-ai-overview) .
