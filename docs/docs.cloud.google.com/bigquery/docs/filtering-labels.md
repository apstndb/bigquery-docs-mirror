---
name: documents/docs.cloud.google.com/bigquery/docs/filtering-labels
uri: https://docs.cloud.google.com/bigquery/docs/filtering-labels
title: Filtering resources using labels
