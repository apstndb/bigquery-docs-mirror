---
name: documents/docs.cloud.google.com/bigquery/docs/deleting-models
uri: https://docs.cloud.google.com/bigquery/docs/deleting-models
title: Delete models
