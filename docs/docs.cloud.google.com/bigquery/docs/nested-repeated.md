---
name: documents/docs.cloud.google.com/bigquery/docs/nested-repeated
uri: https://docs.cloud.google.com/bigquery/docs/nested-repeated
title: Specify nested and repeated columns in table schemas
