...
For information about the roles needed to create and use a default connection, see [Required roles and permissions](https://docs.cloud.google.com/bigquery/docs/default-connections#required_roles_and_permissions) .
