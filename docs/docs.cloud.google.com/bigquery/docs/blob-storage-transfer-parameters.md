...
## Notes on parameter usage
  ...
  - If you partition your data based on your local timezone, you need to manually calculate the hour offset from UTC by using the offsetting mechanism in the [templating syntax](https://docs.cloud.google.com/bigquery/docs/blob-storage-transfer-parameters#templating_system) .
...
## What's next
  ...
  - Learn more about [setting up an Azure Blob Storage transfer](https://docs.cloud.google.com/bigquery/docs/blob-storage-transfer) .
