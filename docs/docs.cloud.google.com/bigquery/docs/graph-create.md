---
name: documents/docs.cloud.google.com/bigquery/docs/graph-create
uri: https://docs.cloud.google.com/bigquery/docs/graph-create
title: Create and query a graph
