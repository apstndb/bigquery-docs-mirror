...
Enter the [`  bq mk  ` command](/bigquery/docs/reference/bq-cli-reference#mk-transfer-config) and supply the transfer creation flag — `  --transfer_config  ` .
