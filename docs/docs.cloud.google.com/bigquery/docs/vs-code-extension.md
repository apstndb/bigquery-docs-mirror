---
name: documents/docs.cloud.google.com/bigquery/docs/vs-code-extension
uri: https://docs.cloud.google.com/bigquery/docs/vs-code-extension
title: Use the Google Cloud for Visual Studio Code extension
