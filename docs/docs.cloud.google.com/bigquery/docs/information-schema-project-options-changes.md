---
name: documents/docs.cloud.google.com/bigquery/docs/information-schema-project-options-changes
uri: https://docs.cloud.google.com/bigquery/docs/information-schema-project-options-changes
title: PROJECT_OPTIONS_CHANGES view
