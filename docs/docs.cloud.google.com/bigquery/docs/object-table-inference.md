---
name: documents/docs.cloud.google.com/bigquery/docs/object-table-inference
uri: https://docs.cloud.google.com/bigquery/docs/object-table-inference
title: Run inference on image object tables
