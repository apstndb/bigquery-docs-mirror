---
name: documents/docs.cloud.google.com/bigquery/docs/information-schema-streaming-by-organization
uri: https://docs.cloud.google.com/bigquery/docs/information-schema-streaming-by-organization
title: STREAMING_TIMELINE_BY_ORGANIZATION view
...
The following example calculates a per minute breakdown of successful and failed streaming requests in the project's organization, split into error code categories. This query could be used to populate a dashboard.
...
The following example returns the streaming statistics for the 10 tables in the project's organization with the most incoming traffic:
