---
name: documents/docs.cloud.google.com/bigquery/docs/customer-managed-encryption
uri: https://docs.cloud.google.com/bigquery/docs/customer-managed-encryption
