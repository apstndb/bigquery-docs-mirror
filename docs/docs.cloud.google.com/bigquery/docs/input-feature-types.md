---
name: documents/docs.cloud.google.com/bigquery/docs/input-feature-types
uri: https://docs.cloud.google.com/bigquery/docs/input-feature-types
title: Supported input feature types
