---
name: documents/docs.cloud.google.com/bigquery/docs/information-schema-streaming-by-folder
uri: https://docs.cloud.google.com/bigquery/docs/information-schema-streaming-by-folder
title: STREAMING_TIMELINE_BY_FOLDER view
