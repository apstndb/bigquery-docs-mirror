---
name: documents/docs.cloud.google.com/bigquery/docs/information-schema-schemata-replicas
uri: https://docs.cloud.google.com/bigquery/docs/information-schema-schemata-replicas
title: SCHEMATA_REPLICAS view
