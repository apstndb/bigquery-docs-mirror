---
name: documents/docs.cloud.google.com/bigquery/docs/text-analysis-search
uri: https://docs.cloud.google.com/bigquery/docs/text-analysis-search
title: Work with text analyzers
