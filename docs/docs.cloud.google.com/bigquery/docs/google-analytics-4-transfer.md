---
name: documents/docs.cloud.google.com/bigquery/docs/google-analytics-4-transfer
uri: https://docs.cloud.google.com/bigquery/docs/google-analytics-4-transfer
title: Load Google Analytics 4 data into BigQuery
