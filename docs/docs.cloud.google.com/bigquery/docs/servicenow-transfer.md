---
name: documents/docs.cloud.google.com/bigquery/docs/servicenow-transfer
uri: https://docs.cloud.google.com/bigquery/docs/servicenow-transfer
title: Load ServiceNow data into BigQuery
