---
name: documents/docs.cloud.google.com/bigquery/docs/iceberg-ingestion
uri: https://docs.cloud.google.com/bigquery/docs/iceberg-ingestion
title: Transfer data into Iceberg managed table
