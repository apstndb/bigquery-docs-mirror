---
name: documents/docs.cloud.google.com/bigquery/docs/work-with-objectref
uri: https://docs.cloud.google.com/bigquery/docs/work-with-objectref
title: Work with ObjectRef values
