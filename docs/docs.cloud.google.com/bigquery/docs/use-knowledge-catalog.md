...
To migrate to Knowledge Catalog, follow the steps in [Transition from Data Catalog to Knowledge Catalog](https://docs.cloud.google.com/dataplex/docs/transition-to-dataplex-catalog) .

To update programmatic workflows to the Knowledge Catalog API, see [Map Data Catalog API methods to Knowledge Catalog](https://docs.cloud.google.com/dataplex/docs/catalog-overview#map-api-methods) .
