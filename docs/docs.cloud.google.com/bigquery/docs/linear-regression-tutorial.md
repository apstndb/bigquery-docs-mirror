---
name: documents/docs.cloud.google.com/bigquery/docs/linear-regression-tutorial
uri: https://docs.cloud.google.com/bigquery/docs/linear-regression-tutorial
title: Use BigQuery ML to predict penguin weight
...
After creating the model, evaluate the model's performance by using the [`ML.EVALUATE` function](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/bigqueryml-syntax-evaluate) or the [`bigframes.bigquery.ml.evaluate` BigQuery DataFrames function](https://dataframes.bigquery.dev/reference/api/bigframes.bigquery.ml.evaluate.html#bigframes.bigquery.ml.evaluate) to evaluate the predicted values generated by the model against the actual data.
