---
name: documents/docs.cloud.google.com/bigquery/docs/geospatial-get-started
uri: https://docs.cloud.google.com/bigquery/docs/geospatial-get-started
title: Get started with geospatial analytics
