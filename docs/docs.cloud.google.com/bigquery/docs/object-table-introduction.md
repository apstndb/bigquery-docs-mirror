---
name: documents/docs.cloud.google.com/bigquery/docs/object-table-introduction
uri: https://docs.cloud.google.com/bigquery/docs/object-table-introduction
title: Introduction to object tables
...
You can query the metadata in an object table in the same way you would query any other BigQuery table. However, the primary use case for object tables is to make unstructured data accessible for analysis. You can use BigQuery ML to [run inference on image object tables](https://docs.cloud.google.com/bigquery/docs/object-table-inference) with TensorFlow, TensorFlow Lite, and PyTorch models. You can also use [remote functions](https://docs.cloud.google.com/bigquery/docs/remote-functions) to [analyze unstructured data](https://docs.cloud.google.com/bigquery/docs/object-table-remote-function) almost any way you want to. For example, you could create a remote function that lets you analyze images by using [Cloud Vision](https://docs.cloud.google.com/vision/docs) , or one that lets you extract metadata from PDF documents by using [Apache Tika](https://tika.apache.org/) .
...
To get access to the data represented by an object, generate a signed URL. You can use the signed URL to directly view the object data, and you can also [pass signed URLs to remote functions](https://docs.cloud.google.com/bigquery/docs/object-table-remote-function) to enable them to work with object table data.
...
You can create an object table over any type and size of unstructured data file, and you can create remote functions to work with any type of unstructured data. However, to perform inference by using BigQuery ML, an object table can only be over image files that meet several size and type requirements. For more information, see [Limitations](https://docs.cloud.google.com/bigquery/docs/object-table-inference#limitations) .
...
For more information on setting metadata caching options, see [Create object tables](https://docs.cloud.google.com/bigquery/docs/object-tables#create-object-table) .
