---
name: documents/docs.cloud.google.com/bigquery/docs/storage_overview
uri: https://docs.cloud.google.com/bigquery/docs/storage_overview
...
![**Figure 1.** BigQuery architecture.](https://docs.cloud.google.com/static/bigquery/images/bigquery-storage-architecture.png)
...
![**Figure 2.** Row-oriented format.](https://docs.cloud.google.com/static/bigquery/images/row-oriented-store.png)
...
![**Figure 3.** Column-oriented format.](https://docs.cloud.google.com/static/bigquery/images/column-oriented-store.png)
...
Datasets use [time travel](https://docs.cloud.google.com/bigquery/docs/time-travel#time_travel) and [fail-safe](https://docs.cloud.google.com/bigquery/docs/time-travel#fail-safe) storage for data retention. Time travel and fail-safe storage are charged separately at active storage rates when you use physical storage billing, but are included in the base rate you are charged when you use logical storage billing. You can modify the time travel window you use for a dataset in order to balance physical storage costs with data retention. You can't modify the fail-safe window. For more information about dataset data retention, see [Data retention with time travel and fail-safe](https://docs.cloud.google.com/bigquery/docs/time-travel) . For more information on forecasting your storage costs, see [Forecast storage billing](https://docs.cloud.google.com/bigquery/docs/information-schema-table-storage#forecast_storage_billing) .
