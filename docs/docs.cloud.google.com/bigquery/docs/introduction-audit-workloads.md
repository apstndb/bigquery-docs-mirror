...
For more information about the types of audit logs that Google Cloud services write, see [Types of audit logs](https://docs.cloud.google.com/logging/docs/audit#types) .
