...
Create a [view](https://docs.cloud.google.com/bigquery/docs/views-intro) a view with the sample data. This view is used by the `CREATE MODEL` statement later in this tutorial.
...
The [`ML.EVALUATE` function](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/bigqueryml-syntax-evaluate) function evaluates the predicted values generated by the model against the evaluation data.
