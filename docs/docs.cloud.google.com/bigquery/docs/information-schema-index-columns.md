---
name: documents/docs.cloud.google.com/bigquery/docs/information-schema-index-columns
uri: https://docs.cloud.google.com/bigquery/docs/information-schema-index-columns
title: SEARCH_INDEX_COLUMNS view
