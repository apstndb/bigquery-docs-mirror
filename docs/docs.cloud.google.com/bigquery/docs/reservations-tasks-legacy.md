---
name: documents/docs.cloud.google.com/bigquery/docs/reservations-tasks-legacy
uri: https://docs.cloud.google.com/bigquery/docs/reservations-tasks-legacy
...
7.  If you select the **Flat-Rate** option, under **Baseline slots** , enter the number of slots for the reservation.
    ...
    2.  Optional: In the **Baseline slots** field, enter the number of baseline slots for the reservation. To use only the specified slot capacity, click the **Ignore idle slots** toggle.
        ...
        The amount of autoscaling slots available to you is determined by subtracting the baseline slots value from the maximum reservation size value. For example, if you create a reservation with 100 baseline slots and a max reservation size of 400, your reservation has 300 autoscaling slots. For more information about baseline slots, see [Using reservations with baseline and autoscaling slots](https://docs.cloud.google.com/bigquery/docs/slots-autoscaling-intro#using_reservations_with_baseline_and_autoscaling_slots) .
