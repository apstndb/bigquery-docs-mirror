...
## What's next
  ...
  - For more information about building graphs for measures and modeling many-to-many relationships, see [Work with measures](https://docs.cloud.google.com/bigquery/docs/graph-measures#best-practices) .
