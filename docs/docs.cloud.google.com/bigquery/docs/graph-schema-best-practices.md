---
name: documents/docs.cloud.google.com/bigquery/docs/graph-schema-best-practices
uri: https://docs.cloud.google.com/bigquery/docs/graph-schema-best-practices
title: Graph schema best practices
...
## What's next
  ...
  - For more information about building graphs for measures and modeling many-to-many relationships, see [Work with measures](https://docs.cloud.google.com/bigquery/docs/graph-measures#work_with_measures) .
