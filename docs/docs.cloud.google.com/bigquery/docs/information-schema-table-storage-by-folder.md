...
To query the `  INFORMATION_SCHEMA.TABLE_STORAGE_BY_FOLDER  ` view, you need the following Identity and Access Management (IAM) permissions for the parent folder of the project:
...
The `  INFORMATION_SCHEMA.TABLE_STORAGE_BY_FOLDER  ` view has the following schema:
