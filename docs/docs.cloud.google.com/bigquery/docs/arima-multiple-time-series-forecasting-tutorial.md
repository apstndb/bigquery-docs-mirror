---
name: documents/docs.cloud.google.com/bigquery/docs/arima-multiple-time-series-forecasting-tutorial
uri: https://docs.cloud.google.com/bigquery/docs/arima-multiple-time-series-forecasting-tutorial
...
2.  In the query editor, paste in the following query and click **Run** :
    ...
    ![The first nine output columns of forecasted data and forecast explanations.](https://docs.cloud.google.com/static/bigquery/images/arima-multi-series-ml-explain-forecast1.png) ![The tenth through seventeenth output columns of forecasted data and forecast explanations.](https://docs.cloud.google.com/static/bigquery/images/arima-multi-series-ml-explain-forecast2.png) ![The last six output columns of forecasted data and forecast explanations.](https://docs.cloud.google.com/static/bigquery/images/arima-multi-series-ml-explain-forecast3.png)
