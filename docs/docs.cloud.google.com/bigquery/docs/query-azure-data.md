...
This document describes how to query data stored in an [Azure Blob Storage BigLake table](/bigquery/docs/omni-azure-create-external-table) .
...
After creating a Blob Storage BigLake table, you can [query it using GoogleSQL syntax](/bigquery/docs/running-queries) , the same as if it were a standard BigQuery table.
