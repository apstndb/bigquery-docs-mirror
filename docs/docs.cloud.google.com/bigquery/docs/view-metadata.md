---
name: documents/docs.cloud.google.com/bigquery/docs/view-metadata
uri: https://docs.cloud.google.com/bigquery/docs/view-metadata
title: Get information about views
