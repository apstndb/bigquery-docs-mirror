...
You can use [remote models over Gemini Enterprise Agent Platform models](https://docs.cloud.google.com/bigquery/docs/generative-ai-overview) and remote models over Cloud AI services together with BigQuery ML functions in order to accomplish complex data analysis and generative AI tasks.

The following diagram shows some typical workflows where you might use these capabilities together:

![Diagram showing common workflows for remote models that use Agent Platform models or Cloud AI services.](https://docs.cloud.google.com/static/bigquery/images/gen-ai-workflow.png)
