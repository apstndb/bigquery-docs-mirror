---
name: documents/docs.cloud.google.com/bigquery/docs/differential-privacy
uri: https://docs.cloud.google.com/bigquery/docs/differential-privacy
...
In the "Query syntax" reference, see [Limit the groups in which a privacy unit ID can exist](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/query-syntax#limit_groups_for_privacy_unit) .
