---
name: documents/docs.cloud.google.com/bigquery/docs/gcs-transfer-parameters
uri: https://docs.cloud.google.com/bigquery/docs/gcs-transfer-parameters
title: Runtime parameters in Cloud Storage transfers
