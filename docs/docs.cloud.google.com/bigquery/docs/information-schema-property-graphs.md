---
name: documents/docs.cloud.google.com/bigquery/docs/information-schema-property-graphs
uri: https://docs.cloud.google.com/bigquery/docs/information-schema-property-graphs
title: PROPERTY_GRAPHS view
