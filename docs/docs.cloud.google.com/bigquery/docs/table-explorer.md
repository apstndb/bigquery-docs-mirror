---
name: documents/docs.cloud.google.com/bigquery/docs/table-explorer
uri: https://docs.cloud.google.com/bigquery/docs/table-explorer
...
For more information about BigQuery compute pricing, see [Pricing](https://cloud.google.com/bigquery/pricing) .
...
4.  Click **Overview \> Tables** , and then select a table for which you want to create a query.
...
7.  For a partitioned table, in the **Partitioning filter** section, set a custom partitioning filter. Partition filters can reduce the billable compute when exploring tables.
...
11. To continue table exploration, select new fields or distinct values from the refreshed displayed cards.
