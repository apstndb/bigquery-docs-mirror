---
name: documents/docs.cloud.google.com/bigquery/docs/updating-model-metadata
uri: https://docs.cloud.google.com/bigquery/docs/updating-model-metadata
...
Labels are key-value pairs that you can attach to a resource. When you create BigQuery ML resources, labels are optional. For more information, see [Adding and using labels](https://docs.cloud.google.com/bigquery/docs/adding-using-labels) .
