---
name: documents/docs.cloud.google.com/bigquery/docs/information-schema-shared-dataset-usage
uri: https://docs.cloud.google.com/bigquery/docs/information-schema-shared-dataset-usage
title: INFORMATION_SCHEMA.SHARED_DATASET_USAGE view
