...
To familiarize yourself with how access is managed in Google Cloud, see [IAM overview](https://docs.cloud.google.com/iam/docs/overview) .
...
For additional information on using IAM to manage access to Resource Manager resources, see [Manage access to projects, folders, and organizations](https://docs.cloud.google.com/iam/docs/granting-changing-revoking-access) in the IAM documentation.
