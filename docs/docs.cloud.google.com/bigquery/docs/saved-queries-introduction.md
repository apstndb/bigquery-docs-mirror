...
For more information, see [Saved query quotas and limits](https://docs.cloud.google.com/bigquery/quotas#saved_query_limits) .
...
The saved queries feature of [BigQuery Studio](https://docs.cloud.google.com/bigquery/docs/enable-assets) is replacing classic saved queries. The deprecation timeline is being reviewed. To edit existing classic saved queries after deprecation, you must [migrate classic queries](https://docs.cloud.google.com/bigquery/docs/manage-saved-queries#migrate_classic_saved_queries) to BigQuery Studio saved queries.
...
[Custom roles](https://docs.cloud.google.com/iam/docs/roles-overview#custom) won't be automatically updated. To update a custom role with the [required permissions](https://docs.cloud.google.com/bigquery/docs/work-with-saved-queries#required_permissions) , see [Edit an existing custom role](https://docs.cloud.google.com/iam/docs/creating-custom-roles#edit-role) .
