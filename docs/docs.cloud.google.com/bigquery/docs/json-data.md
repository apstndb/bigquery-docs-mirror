---
name: documents/docs.cloud.google.com/bigquery/docs/json-data
uri: https://docs.cloud.google.com/bigquery/docs/json-data
title: Work with JSON data in GoogleSQL
description: A fully managed, petabyte-scale analytics data warehouse that lets you run analytics over vast amounts of data in near real time.
data_source: docs.cloud.google.com
---

# Work with JSON data in GoogleSQL
...
BigQuery natively supports JSON data using the [`JSON`](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/data-types#json_type) data type.
...
To load this file using the bq command-line tool, use the [`bq load`](https://docs.cloud.google.com/bigquery/docs/reference/bq-cli-reference#bq_load) command:
...
Append the rows to the write stream as shown in the [code example](https://docs.cloud.google.com/bigquery/docs/write-api-streaming#at-least-once) . The client library handles serialization to protocol buffer format.
...
For more information, see [Streaming data into BigQuery](https://docs.cloud.google.com/bigquery/docs/streaming-data-into-bigquery#streaminginsertexamples) .
...
These operators improve readability for the basic functionality of the [`JSON_QUERY`](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/json_functions#json_query) function. For example, the expression `cart.name` is equivalent to `JSON_QUERY(cart, "$.name")` .
...
In addition to [`STRING`](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/json_functions#string_for_json) , you might have to extract `JSON` values and return them as another SQL data type. The following value extraction functions are available:
...
To obtain the type of the `JSON` value, you can use the [`JSON_TYPE`](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/json_functions#json_type) function.

### Flexibly convert JSON

You can convert a `JSON` value to a scalar SQL value flexibly with [`LAX conversion`](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/json_functions#lax_converters) functions.
...
In addition to [`LAX_INT64`](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/json_functions#lax_int64) , you can convert to other SQL types flexibly to JSON with the following functions:
...
For more information about arrays, see [Working with arrays in GoogleSQL](https://docs.cloud.google.com/bigquery/docs/arrays) .
