---
name: documents/docs.cloud.google.com/bigquery/docs/information-schema-vector-index-options
uri: https://docs.cloud.google.com/bigquery/docs/information-schema-vector-index-options
title: VECTOR_INDEX_OPTIONS view
