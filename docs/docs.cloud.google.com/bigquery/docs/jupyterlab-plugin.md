---
name: documents/docs.cloud.google.com/bigquery/docs/jupyterlab-plugin
uri: https://docs.cloud.google.com/bigquery/docs/jupyterlab-plugin
title: Use the BigQuery JupyterLab plugin
