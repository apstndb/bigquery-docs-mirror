---
name: documents/docs.cloud.google.com/bigquery/docs/change-history
uri: https://docs.cloud.google.com/bigquery/docs/change-history
title: Work with change history
description: Describes how to view the change history of a BigQuery table.
...
You can use the following functions to understand a table's change history:
  ...
  - [`APPENDS`](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/time-series-functions#appends) : returns all rows appended to a table for given time range.
