...
![Semantically similar concepts, like \_cat\_, \_dog\_, and \_lion\_, or \_car\_, \_truck\_, and \_vehicle\_, are close together in the embedding space.](https://docs.cloud.google.com/static/bigquery/images/embedding-space.png)
...
For more information, see [Vector index limits](https://docs.cloud.google.com/bigquery/quotas#vector_index_limits) and [generative AI function limits](https://docs.cloud.google.com/bigquery/quotas#generative_ai_functions) .
