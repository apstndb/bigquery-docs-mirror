---
name: documents/docs.cloud.google.com/bigquery/docs/dataframes-data-types
uri: https://docs.cloud.google.com/bigquery/docs/dataframes-data-types
title: Use the BigQuery DataFrames data type system
...
When used with local data, BigQuery DataFrames converts data types to their corresponding BigQuery DataFrames equivalents wherever a [type mapping is defined](https://docs.cloud.google.com/bigquery/docs/dataframes-data-types#type-mappings) , as shown in the following example:
