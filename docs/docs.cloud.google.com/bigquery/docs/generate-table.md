---
name: documents/docs.cloud.google.com/bigquery/docs/generate-table
uri: https://docs.cloud.google.com/bigquery/docs/generate-table
title: Generate structured data by using the AI.GENERATE_TABLE function
