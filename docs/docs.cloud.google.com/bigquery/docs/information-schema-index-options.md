---
name: documents/docs.cloud.google.com/bigquery/docs/information-schema-index-options
uri: https://docs.cloud.google.com/bigquery/docs/information-schema-index-options
title: SEARCH_INDEX_OPTIONS view
