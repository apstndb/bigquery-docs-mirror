---
name: documents/docs.cloud.google.com/bigquery/docs/restore-deleted-datasets
uri: https://docs.cloud.google.com/bigquery/docs/restore-deleted-datasets
title: Restore deleted datasets
description: Describes how to restore (or undelete) a deleted dataset in BigQuery.
