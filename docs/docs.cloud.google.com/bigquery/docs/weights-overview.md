---
name: documents/docs.cloud.google.com/bigquery/docs/weights-overview
uri: https://docs.cloud.google.com/bigquery/docs/weights-overview
title: BigQuery ML model weights overview
