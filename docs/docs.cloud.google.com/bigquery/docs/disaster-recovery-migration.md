---
name: documents/docs.cloud.google.com/bigquery/docs/disaster-recovery-migration
uri: https://docs.cloud.google.com/bigquery/docs/disaster-recovery-migration
title: Migrate to managed disaster recovery
