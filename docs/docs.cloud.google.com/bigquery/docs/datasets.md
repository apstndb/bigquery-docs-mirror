...
BigQuery datasets are subject to the following limitations:
  ...
  - If you change a dataset's [storage billing model](https://docs.cloud.google.com/bigquery/docs/datasets#dataset_storage_billing_models) , you must wait 14 days before you can change the storage billing model again.
...
Optional: Expand the **Tags** section to add [tags](https://docs.cloud.google.com/bigquery/docs/tags#attach_tags_when_you_create_a_new_dataset) to your dataset.
...
7.  To set the dataset's [time travel window](https://docs.cloud.google.com/bigquery/docs/time-travel#time_travel) , choose the window size from the list.
