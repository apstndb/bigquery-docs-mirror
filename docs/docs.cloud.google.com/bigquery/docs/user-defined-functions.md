---
name: documents/docs.cloud.google.com/bigquery/docs/user-defined-functions
uri: https://docs.cloud.google.com/bigquery/docs/user-defined-functions
...
A SQL UDF can return the value of a [scalar subquery](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/subqueries#scalar_subquery_concepts) . A scalar subquery must select a single column.
