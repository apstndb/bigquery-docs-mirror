---
name: documents/docs.cloud.google.com/bigquery/docs/choose-text-generation-function
uri: https://docs.cloud.google.com/bigquery/docs/choose-text-generation-function
title: Choose a text generation function
...
<tr class="odd">
<td>User journey</td>
<td>You must create a <a href="https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/bigqueryml-syntax-create-remote-model#create_model_syntax">remote model</a> before using the function.</td>
