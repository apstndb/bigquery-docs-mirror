...
By default, [hidden datasets](https://docs.cloud.google.com/bigquery/docs/datasets#hidden_datasets) are hidden from the Google Cloud console. To show information about hidden datasets, use the bq command-line tool or the API.
