...
1.  Ensure that your BigQuery administrator has [created a connection](/bigquery/docs/create-cloud-resource-connection#create-cloud-resource-connection) and [set up access to Cloud Storage](/bigquery/docs/create-cloud-resource-connection#access-storage) .
