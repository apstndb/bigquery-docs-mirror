---
name: documents/docs.cloud.google.com/bigquery/docs/audit-logging
uri: https://docs.cloud.google.com/bigquery/docs/audit-logging
title: BigQuery Data Transfer Service audit logging
