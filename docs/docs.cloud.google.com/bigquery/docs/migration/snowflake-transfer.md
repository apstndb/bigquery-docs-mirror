---
name: documents/docs.cloud.google.com/bigquery/docs/migration/snowflake-transfer
uri: https://docs.cloud.google.com/bigquery/docs/migration/snowflake-transfer
title: Schedule a Snowflake transfer
