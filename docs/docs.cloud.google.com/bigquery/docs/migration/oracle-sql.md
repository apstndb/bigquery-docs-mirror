---
name: documents/docs.cloud.google.com/bigquery/docs/migration/oracle-sql
uri: https://docs.cloud.google.com/bigquery/docs/migration/oracle-sql
title: Oracle SQL translation guide
