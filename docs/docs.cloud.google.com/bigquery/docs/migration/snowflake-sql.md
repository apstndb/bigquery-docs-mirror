...
<br />
BigQuery converts <code dir="ltr" translate="no">       INTEGER      </code> to <code dir="ltr" translate="no">       INT64      </code> by default. To configure the SQL translation to convert it to other data types, you can use the <a href="/bigquery/docs/config-yaml-translation#optimize_and_improve_the_performance_of_translated_sql"><code dir="ltr" translate="no">        REWRITE_ZERO_SCALE_NUMERIC_AS_INTEGER       </code> configuration option</a></td>
</tr>
<tr class="odd">
...
<br />
The <code dir="ltr" translate="no">       STRING      </code> data type in BigQuery is stored as variable length UTF-8 encoded Unicode. For more information about column and row limits, see <a href="/bigquery/quotas#query_jobs">Query jobs</a> .</td>
</tr>
<tr class="even">
