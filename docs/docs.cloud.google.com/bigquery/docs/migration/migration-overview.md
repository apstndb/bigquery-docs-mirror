...
We use the following terminology when discussing data warehouse migration:
  ...
  - Data pipeline  
    A process that connects data systems through a series of functions and tasks that perform various types of data transformation. For details, see [What is a data pipeline?](https://docs.cloud.google.com/bigquery/docs/migration/pipelines#what-is-a-data-pipeline) in this series.
...
1.  **Catalog and prioritize use cases**
    ...
    We recommend that you break your migration process into iterations. You catalog both existing and new use cases and assign them a priority. For details, see the [Migrate using an iterative approach](https://docs.cloud.google.com/bigquery/docs/migration/migration-overview#migrating-using-an-iterative-approach) and [Prioritize use cases](https://docs.cloud.google.com/bigquery/docs/migration/migration-overview#prioritizing-use-cases) sections of this document.
...
4.  **Design and propose a proof-of-concept (POC), short-term state, and ideal end state**
    ...
    After you've prioritized your use cases, you can start to think of them over the entire period of the migration. Consider the first use-case migration as a proof of concept (PoC) to validate the initial migration approach. Consider what is achievable within the first few weeks to months as the short-term state. How will your migration plans affect your users? Will they have a hybrid solution, or can you migrate an entire [workload](https://docs.cloud.google.com/bigquery/docs/migration/migration-overview#workload) for a subset of users first?

5.  **Create time and cost estimates**
    
    To ensure a successful migration project, it's important to produce realistic time estimates. To achieve this, engage with all the relevant stakeholders to discuss their availability and agree on their level of engagement throughout the project. This will help you estimate labor costs more accurately. To estimate costs relating to projected cloud resource consumption, see [Estimating storage and query costs](https://docs.cloud.google.com/bigquery/docs/estimate-costs) and [Introduction to controlling BigQuery costs](https://docs.cloud.google.com/bigquery/docs/controlling-costs) in the BigQuery documentation.
...
You can also enhance the user experience with predictive and prescriptive analytics. For that, you can use [BigQuery ML](https://docs.cloud.google.com/bigquery/docs/bqml-introduction) , [Gemini Enterprise Agent Platform AutoML tabular](https://docs.cloud.google.com/gemini-enterprise-agent-platform/machine-learning/start/training-methods) , or Google's pre-trained models for [image analysis](https://cloud.google.com/vision/) , [video analysis](https://cloud.google.com/video-intelligence/) , [speech recognition](https://cloud.google.com/speech-to-text/) , [natural language](https://cloud.google.com/natural-language/) , and [translation](https://cloud.google.com/translate/) . Or you can serve your custom-trained model using [Gemini Enterprise Agent Platform](https://cloud.google.com/vertex-ai) for use cases tailored to your business needs. This might involve the following:
...
The [data governance](https://docs.cloud.google.com/bigquery/docs/data-governance) documentation helps you understand data governance and the controls that you need when migrating your on-premises data warehouse to BigQuery.
...
The [schema and data transfer](https://docs.cloud.google.com/bigquery/docs/migration/schema-data-overview) documentation provides extensive information on how you can move your data to BigQuery and recommendations for updating your schema to take full advantage of BigQuery's features.
...
[Business applications](https://docs.cloud.google.com/bigquery/docs/migration/migration-overview#business-application) can take many forms—from dashboards to custom applications to operational data pipelines that provide feedback loops to transactional systems.

To learn more about the analytics options when working with BigQuery, see [Overview of BigQuery analytics](https://docs.cloud.google.com/bigquery/docs/query-overview) . This topic provides an overview of the reporting and analysis tools that you can use to get compelling insights from your data.

The section on [feedback loops](https://docs.cloud.google.com/bigquery/docs/migration/pipelines#feedback-loops) in the data pipeline documentation describes how you can use a data pipeline to create a feedback loop to provision upstream systems.
