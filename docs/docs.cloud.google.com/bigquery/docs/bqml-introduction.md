...
You can create a [contribution analysis](https://docs.cloud.google.com/bigquery/docs/contribution-analysis) model to generate insights about changes to key metrics in your multi-dimensional data. For example, you can find out what data contributed to a change in revenue.
...
BigQuery ML lets you import custom models that are trained outside of BigQuery and then perform prediction within BigQuery. You can import the following models into BigQuery from [Cloud Storage](https://docs.cloud.google.com/storage) :
...
You can now use Colab Enterprise notebooks to perform ML workflows in BigQuery. Notebooks let you use SQL, Python, and other popular libraries and languages to accomplish your ML tasks. For more information, see [Create notebooks](https://docs.cloud.google.com/bigquery/docs/create-notebooks) .

## Supported regions

BigQuery ML is supported in the same regions as BigQuery. For more information, see [BigQuery ML locations](https://docs.cloud.google.com/bigquery/docs/locations#bqml-loc) .
