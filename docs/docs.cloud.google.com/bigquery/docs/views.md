...
4.  Click ![](https://docs.cloud.google.com/static/bigquery/images/save-bigquery-console.png) **Save \> Save view** .
...
After the view is created, you can update the view's expiration, description, and labels. For more information, see [Updating views](https://docs.cloud.google.com/bigquery/docs/updating-views) .
...
After you create the view, you [query](https://docs.cloud.google.com/bigquery/docs/running-queries) it like you query a table.
