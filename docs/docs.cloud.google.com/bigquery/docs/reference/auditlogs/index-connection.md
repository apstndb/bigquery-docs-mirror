---
name: documents/docs.cloud.google.com/bigquery/docs/reference/auditlogs/index-connection
uri: https://docs.cloud.google.com/bigquery/docs/reference/auditlogs/index-connection
title: BigQuery Connection API audit logging
