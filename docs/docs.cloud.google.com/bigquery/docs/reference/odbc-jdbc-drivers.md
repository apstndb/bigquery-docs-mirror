...
1.  Download the 3.2.1.3001 version of the driver for your operating system:
    
      - [Windows 32-bit](https://storage.googleapis.com/simba-bq-release/odbc/SimbaODBCDriverforGoogleBigQuery32_3.2.1.3001.msi) ( `.msi` file)
      - [Windows 64-bit](https://storage.googleapis.com/simba-bq-release/odbc/SimbaODBCDriverforGoogleBigQuery64_3.2.1.3001.msi) ( `.msi` file)
      - [Linux 32-bit and 64-bit](https://storage.googleapis.com/simba-bq-release/odbc/SimbaODBCDriverforGoogleBigQuery_3.2.1.3001-Linux.tar.gz) ( `.tar.gz` file)
      - [macOS](https://storage.googleapis.com/simba-bq-release/odbc/SimbaODBCDriverforGoogleBigQuery-3.2.1.3001.dmg) ( `.dmg` file)

2.  Follow the instructions in the [insightsoftware installation and configuration guide](https://storage.googleapis.com/simba-bq-release/odbc/Simba%20Google%20BigQuery%20ODBC%20Connector%20Install%20and%20Configuration%20Guide-3.2.1.3001.pdf) .

For information on feature changes and workflow updates, see [Simba Google BigQuery ODBC Data Connector Release Notes](https://storage.googleapis.com/simba-bq-release/odbc/release-notes-3.2.1.3001.txt) .
