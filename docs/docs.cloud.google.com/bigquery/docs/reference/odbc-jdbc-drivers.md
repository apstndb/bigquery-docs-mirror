...
For information on feature changes and workflow updates, see [Simba Google BigQuery ODBC Data Connector Release Notes](https://storage.googleapis.com/simba-bq-release/odbc/release-notes-3.4.1.3004.txt) .
