---
name: documents/docs.cloud.google.com/bigquery/docs/reference/datatransfer/rest
uri: https://docs.cloud.google.com/bigquery/docs/reference/datatransfer/rest
