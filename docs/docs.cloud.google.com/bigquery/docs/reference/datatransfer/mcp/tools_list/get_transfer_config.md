---
name: documents/docs.cloud.google.com/bigquery/docs/reference/datatransfer/mcp/tools_list/get_transfer_config
uri: https://docs.cloud.google.com/bigquery/docs/reference/datatransfer/mcp/tools_list/get_transfer_config
...
The following sample demonstrate how to use `curl` to invoke the `get_transfer_config` MCP tool.
