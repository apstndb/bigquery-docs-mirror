---
name: documents/docs.cloud.google.com/bigquery/docs/reference/datatransfer/mcp/tools_list/get_data_source
uri: https://docs.cloud.google.com/bigquery/docs/reference/datatransfer/mcp/tools_list/get_data_source
...
The following code sample shows how to use `curl` to call the `get_data_source` MCP tool.
