---
name: documents/docs.cloud.google.com/bigquery/docs/reference/datatransfer/mcp/tools_list/update_transfer_config
uri: https://docs.cloud.google.com/bigquery/docs/reference/datatransfer/mcp/tools_list/update_transfer_config
title: 'MCP Tools Reference: bigquerydatatransfer.googleapis.com'
description: A fully managed, petabyte-scale analytics data warehouse that lets you run analytics over vast amounts of data in near real time.
data_source: docs.cloud.google.com
---

## Tool: `update_transfer_config`
...
The following sample demonstrate how to use `curl` to invoke the `update_transfer_config` MCP tool.
...
Required. Location of the transfer config.

`transferConfigId`

`string`

Required. Transfer config ID.

`params`

` object ( Struct  ` format)

Data source parameters for the transfer config.

`scheduleOptions`

` object ( ScheduleOptionsV2  ` )

Schedule options for the transfer config.
...
Display name of the transfer config.

Union field `_destination_dataset_id` .

`_destination_dataset_id` can be only one of the following:

`destinationDatasetId`

`string`

Destination dataset ID of the transfer config where data will be loaded.
