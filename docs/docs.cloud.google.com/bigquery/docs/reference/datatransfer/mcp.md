...
[list\_data\_sources](/bigquery/docs/reference/datatransfer/mcp/tools_list/list_data_sources)
...
[get\_data\_source](/bigquery/docs/reference/datatransfer/mcp/tools_list/get_data_source)

Get details about a data source.

[create\_transfer\_config](/bigquery/docs/reference/datatransfer/mcp/tools_list/create_transfer_config)
...
[get\_transfer\_config](/bigquery/docs/reference/datatransfer/mcp/tools_list/get_transfer_config)
...
[list\_transfer\_configs](/bigquery/docs/reference/datatransfer/mcp/tools_list/list_transfer_configs)
...
[start\_manual\_transfer\_runs](/bigquery/docs/reference/datatransfer/mcp/tools_list/start_manual_transfer_runs)
...
[list\_transfer\_runs](/bigquery/docs/reference/datatransfer/mcp/tools_list/list_transfer_runs)
...
[get\_transfer\_run](/bigquery/docs/reference/datatransfer/mcp/tools_list/get_transfer_run)
...
[check\_valid\_creds](/bigquery/docs/reference/datatransfer/mcp/tools_list/check_valid_creds)
...
<tbody>
<tr class="odd">
<td><pre class="text" dir="ltr" data-is-upgraded="" data-syntax="Bash" translate="no"><code>                      curl --location &#39;https://bigquerydatatransfer.googleapis.com/mcp&#39; \
