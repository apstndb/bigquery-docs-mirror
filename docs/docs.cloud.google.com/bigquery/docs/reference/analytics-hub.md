---
name: documents/docs.cloud.google.com/bigquery/docs/reference/analytics-hub
uri: https://docs.cloud.google.com/bigquery/docs/reference/analytics-hub
title: Sharing Client Libraries
description: Information about interacting with Analytics Hub API in C#, Go, Java, Node.js, PHP, Python, Ruby.
...
If you are using [sbt](https://www.scala-sbt.org/) , add the following to your dependencies:
    ...
    libraryDependencies += "com.google.cloud" % "google-cloud-analyticshub" % "0.93.0"
