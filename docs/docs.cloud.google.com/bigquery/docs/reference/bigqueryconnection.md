---
name: documents/docs.cloud.google.com/bigquery/docs/reference/bigqueryconnection
uri: https://docs.cloud.google.com/bigquery/docs/reference/bigqueryconnection
title: BigQuery Connection API Client Libraries
description: Information about interacting with BigQuery Connection API in C#, Go, Java, Node.js, PHP, Python, Ruby.
