---
name: documents/docs.cloud.google.com/bigquery/docs/reference/standard-sql/date_functions
uri: https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/date_functions
...
**Definitions**
  ...
  - `granularity` : The date part that represents the granularity. If you have passed in `DATE` values for the first arguments, `granularity` can be:
