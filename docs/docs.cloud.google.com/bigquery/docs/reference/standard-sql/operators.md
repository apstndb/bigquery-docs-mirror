...
Array position. Must be used with `  OFFSET  ` or `  ORDINAL  ` —see [Array Functions](/bigquery/docs/reference/standard-sql/array_functions) .
...
Any comparable type. See [Data Types](/bigquery/docs/reference/standard-sql/data-types) for a complete list.
...
Any comparable types. See [Data Types](/bigquery/docs/reference/standard-sql/data-types) for a complete list.
...
<td>See the <a href="#is_distinct"><code dir="ltr" translate="no">        IS DISTINCT FROM       </code> operator</a> for details.</td>
</tr>
</tbody>
</table>
