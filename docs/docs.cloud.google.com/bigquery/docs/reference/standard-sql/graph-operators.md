---
name: documents/docs.cloud.google.com/bigquery/docs/reference/standard-sql/graph-operators
uri: https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/graph-operators
title: GQL operators
