...
`ML.GENERATE_TEXT` must run in the same [region or multi-region](https://docs.cloud.google.com/bigquery/docs/locations) as the remote model that the function references. See the following topics for more information:
