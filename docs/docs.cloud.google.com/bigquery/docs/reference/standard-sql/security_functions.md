---
name: documents/docs.cloud.google.com/bigquery/docs/reference/standard-sql/security_functions
uri: https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/security_functions
