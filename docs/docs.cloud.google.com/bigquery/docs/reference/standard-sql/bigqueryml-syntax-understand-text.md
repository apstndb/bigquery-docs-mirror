---
name: documents/docs.cloud.google.com/bigquery/docs/reference/standard-sql/bigqueryml-syntax-understand-text
uri: https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/bigqueryml-syntax-understand-text
title: The ML.UNDERSTAND_TEXT function
description: Analyze BigQuery text data with the `ML.UNDERSTAND_TEXT`function and the Cloud Natural Language API.
