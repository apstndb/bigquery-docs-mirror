...
The `  OBJ.FETCH_METADATA  ` function returns Cloud Storage metadata for a partially populated [`  ObjectRef  `](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/objectref_functions#objectref) value.
