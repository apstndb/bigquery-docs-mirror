---
name: documents/docs.cloud.google.com/bigquery/docs/reference/standard-sql/bigqueryml-syntax-create-tensorflow
uri: https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/bigqueryml-syntax-create-tensorflow
title: The CREATE MODEL statement for importing TensorFlow models
description: Use the CREATE MODEL statement for importing TensorFlow models into BigQuery.
