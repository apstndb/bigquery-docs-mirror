---
name: documents/docs.cloud.google.com/bigquery/docs/reference/standard-sql/bigqueryml-syntax-trial-info
uri: https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/bigqueryml-syntax-trial-info
title: The ML.TRIAL_INFO function
description: Display information about trials from a BigQuery ML model that uses hyperparameter tuning.
