---
name: documents/docs.cloud.google.com/bigquery/docs/reference/standard-sql/graph-intro
uri: https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/graph-intro
title: GQL overview
