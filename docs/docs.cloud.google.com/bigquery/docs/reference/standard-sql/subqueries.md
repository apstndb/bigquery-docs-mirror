---
name: documents/docs.cloud.google.com/bigquery/docs/reference/standard-sql/subqueries
uri: https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/subqueries
title: Subqueries
...
Expression subqueries are used in a query wherever expressions are valid. They return a single value, as opposed to a column or table. Expression subqueries can be [correlated](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/subqueries#correlated_subquery_concepts) .
...
A correlated subquery is a subquery that references a column from outside that subquery. Correlation prevents reusing of the subquery result. You can learn more about this [here](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/subqueries#evaluation_rules_subqueries) .
