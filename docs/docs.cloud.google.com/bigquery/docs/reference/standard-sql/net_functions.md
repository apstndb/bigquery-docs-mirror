---
name: documents/docs.cloud.google.com/bigquery/docs/reference/standard-sql/net_functions
uri: https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/net_functions
title: Net functions
...
Similar to [`NET.IP_FROM_STRING`](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/net_functions#netip_from_string) , but returns `NULL` instead of throwing an error if the input is invalid.
