...
![A graph that visualizes the monitoring output for the \`ML.VALIDATE\_DATA\_DRIFT\` function](https://docs.cloud.google.com/static/bigquery/images/model-monitoring-results.png)
...
![A bar chart that visualizes the monitoring output for the \`ML.VALIDATE\_DATA\_DRIFT function](https://docs.cloud.google.com/static/bigquery/images/model-monitoring-results2.png)
