---
name: documents/docs.cloud.google.com/bigquery/docs/reference/standard-sql/export-statements
uri: https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/export-statements
title: Export statements in GoogleSQL
