---
name: documents/docs.cloud.google.com/bigquery/docs/reference/rest/v2/rowAccessPolicies/update
uri: https://docs.cloud.google.com/bigquery/docs/reference/rest/v2/rowAccessPolicies/update
title: 'Method: rowAccessPolicies.update'
