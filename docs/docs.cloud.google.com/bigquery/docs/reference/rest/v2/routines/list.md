---
name: documents/docs.cloud.google.com/bigquery/docs/reference/rest/v2/routines/list
uri: https://docs.cloud.google.com/bigquery/docs/reference/rest/v2/routines/list
title: 'Method: routines.list'
