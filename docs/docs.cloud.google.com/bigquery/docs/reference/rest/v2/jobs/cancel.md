---
name: documents/docs.cloud.google.com/bigquery/docs/reference/rest/v2/jobs/cancel
uri: https://docs.cloud.google.com/bigquery/docs/reference/rest/v2/jobs/cancel
title: 'Method: jobs.cancel'
...
Requires the `bigquery.jobs.update` permission on the job resource. If the user matches the creator of the job, the `bigquery.jobs.create` permission on the project is required instead.
