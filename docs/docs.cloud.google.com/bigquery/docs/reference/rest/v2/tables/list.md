---
name: documents/docs.cloud.google.com/bigquery/docs/reference/rest/v2/tables/list
uri: https://docs.cloud.google.com/bigquery/docs/reference/rest/v2/tables/list
title: 'Method: tables.list'
