---
name: documents/docs.cloud.google.com/bigquery/docs/reference/rest/v2/tables/update
uri: https://docs.cloud.google.com/bigquery/docs/reference/rest/v2/tables/update
title: 'Method: tables.update'
