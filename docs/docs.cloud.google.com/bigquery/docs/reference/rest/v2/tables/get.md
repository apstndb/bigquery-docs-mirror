---
name: documents/docs.cloud.google.com/bigquery/docs/reference/rest/v2/tables/get
uri: https://docs.cloud.google.com/bigquery/docs/reference/rest/v2/tables/get
title: 'Method: tables.get'
