---
name: documents/docs.cloud.google.com/bigquery/docs/reference/rest/v2/datasets/list
uri: https://docs.cloud.google.com/bigquery/docs/reference/rest/v2/datasets/list
