---
name: documents/docs.cloud.google.com/bigquery/docs/reference/rest/v2/models
uri: https://docs.cloud.google.com/bigquery/docs/reference/rest/v2/models
title: 'REST Resource: models'
