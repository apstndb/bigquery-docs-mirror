---
name: documents/docs.cloud.google.com/bigquery/docs/reference/rest/v2/tables
uri: https://docs.cloud.google.com/bigquery/docs/reference/rest/v2/tables
title: 'REST Resource: tables'
description: A fully managed, petabyte-scale analytics data warehouse that lets you run analytics over vast amounts of data in near real time.
data_source: docs.cloud.google.com
update_time: "2026-02-05T06:53:06Z"
---
