---
name: documents/docs.cloud.google.com/bigquery/docs/reference/migration/rpc/google.api
uri: https://docs.cloud.google.com/bigquery/docs/reference/migration/rpc/google.api
title: Package google.api
