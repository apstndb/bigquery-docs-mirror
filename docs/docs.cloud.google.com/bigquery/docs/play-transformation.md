---
name: documents/docs.cloud.google.com/bigquery/docs/play-transformation
uri: https://docs.cloud.google.com/bigquery/docs/play-transformation
title: Google Play report transformation
