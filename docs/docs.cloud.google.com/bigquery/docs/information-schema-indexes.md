---
name: documents/docs.cloud.google.com/bigquery/docs/information-schema-indexes
uri: https://docs.cloud.google.com/bigquery/docs/information-schema-indexes
title: SEARCH_INDEXES view
