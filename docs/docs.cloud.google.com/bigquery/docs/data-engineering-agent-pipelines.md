...
This feature uses Gemini Cloud Assist investigations ( [Preview](https://cloud.google.com/products#product-launch-stages) ) and is only available to users with a [Premium Support contract](https://cloud.google.com/support/premium) . For more information about enabling Gemini Cloud Assist investigations, see [Troubleshoot issues with Gemini Cloud Assist Investigations](https://docs.cloud.google.com/cloud-assist/investigations) .
