---
name: documents/docs.cloud.google.com/bigquery/docs/external-data-sources
uri: https://docs.cloud.google.com/bigquery/docs/external-data-sources
title: Introduction to external data sources
