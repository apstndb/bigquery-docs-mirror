---
name: documents/docs.cloud.google.com/bigquery/docs/recommendations-intro
uri: https://docs.cloud.google.com/bigquery/docs/recommendations-intro
...
You can view and manage recommendations across the different recommenders by using BigQuery in the Google Cloud console—either in the BigQuery Active Assist, or by recommendation notifications in BigQuery Studio. You can also view recommendations through various `INFORMATION_SCHEMA` views at the project and organization level.

To view your BigQuery recommendations along with other recommendations across the Google Cloud console, use the [Active Assist](https://docs.cloud.google.com/recommender/docs/recommendation-hub/find-recommnedation-hub) .
