...
To view your BigQuery recommendations along with other recommendations across the Google Cloud console, use the [Active Assist Active Assist](/recommender/docs/recommendation-hub/find-recommnedation-hub) .
