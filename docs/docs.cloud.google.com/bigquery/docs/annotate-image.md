...
Replace the following:
  ...
  - `  FEATURE_NAME  ` : the name of a supported [Cloud Vision API feature](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/bigqueryml-syntax-annotate-image#syntax) .
