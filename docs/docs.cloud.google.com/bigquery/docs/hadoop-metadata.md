---
name: documents/docs.cloud.google.com/bigquery/docs/hadoop-metadata
uri: https://docs.cloud.google.com/bigquery/docs/hadoop-metadata
title: Extracting metadata from Apache Hive for migration
...
Run the following command to extract metadata from HDFS using the `dwh-migration-dumper` tool.
...
Run the following command to extract metadata from Apache Ranger using the `dwh-migration-dumper` tool.
