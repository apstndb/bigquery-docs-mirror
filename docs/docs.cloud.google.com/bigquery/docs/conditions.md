---
name: documents/docs.cloud.google.com/bigquery/docs/conditions
uri: https://docs.cloud.google.com/bigquery/docs/conditions
...
To view the access policy of a dataset with conditions, call [`datasets.get`](https://docs.cloud.google.com/bigquery/docs/reference/rest/v2/datasets/get) with `accessPolicyVersion=3` as a request parameter. The `access` property in the dataset resource contains the access policy.
...
To add conditional access to an organization, folder, or project in BigQuery, see [Allow policies with conditions](https://docs.cloud.google.com/iam/docs/conditions-overview#syntax_overview) . When building your conditions, refer to the [attribute format tables](https://docs.cloud.google.com/bigquery/docs/conditions#attribute_formats) .

### Add conditional access to dataset

To add conditions to a dataset, select one of the following methods. When you build your conditions, reference the [attribute format tables](https://docs.cloud.google.com/bigquery/docs/conditions#attribute_formats) .
...
9.  Add conditions to the `condition` field using the [condition attributes](https://docs.cloud.google.com/bigquery/docs/conditions#condition_attributes) .
...
To grant conditional access to a dataset using Cloud Shell, follow the directions for [granting access to a dataset](https://docs.cloud.google.com/bigquery/docs/control-access-to-resources-iam#grant_access_to_a_dataset) . You can add your conditional access conditions to the `access` section of the dataset's JSON file.
...
To grant conditional access to a dataset using the BigQuery API, follow the directions for [granting access to a dataset](https://docs.cloud.google.com/bigquery/docs/control-access-to-resources-iam#grant_access_to_a_dataset) with `accessPolicyVersion=3` in the request parameter.

You can add entries with access conditions to the [`access.condition`](https://docs.cloud.google.com/bigquery/docs/reference/rest/v2/datasets) property of the dataset resource.
...
To remove conditions from a dataset, select one of the following methods. When you build your conditions, reference the [attribute format tables](https://docs.cloud.google.com/bigquery/docs/conditions#attribute_formats) .
...
To remove conditional access to a dataset using Cloud Shell, follow the directions in [Revoke access to a dataset](https://docs.cloud.google.com/bigquery/docs/control-access-to-resources-iam#revoke_access_to_a_dataset) . You can remove the entry with condition from the `access` section of the dataset's JSON file.

### API

To revoke conditional access to a dataset using the BigQuery API, follow the directions for [revoking access to a dataset](https://docs.cloud.google.com/bigquery/docs/control-access-to-resources-iam#revoke_access_to_a_dataset) with `accessPolicyVersion=3` in the request parameter.
