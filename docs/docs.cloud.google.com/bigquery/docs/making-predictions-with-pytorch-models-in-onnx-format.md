...
When you finish the tasks that are described in this document, you can avoid continued billing by deleting the resources that you created. For more information, see [Clean up](https://docs.cloud.google.com/bigquery/docs/making-predictions-with-pytorch-models-in-onnx-format#clean-up) .
...
2.  Enable the BigQuery, BigQuery Connection, and Cloud Storage APIs, if any are not already enabled.
...
For more information about IAM permissions in BigQuery, see [IAM permissions](https://docs.cloud.google.com/bigquery/docs/object-table-introduction) .
...
2.  In the query editor, enter the following [`CREATE MODEL`](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/bigqueryml-syntax-create-onnx) statement.
    ...
    ![The information panel for \`imported\_onnx\_model\`.](https://docs.cloud.google.com/static/bigquery/images/onnx-model-info-2.png)
...
You must have a Cloud resource connection to connect to the [object table](https://docs.cloud.google.com/bigquery/docs/object-table-introduction) that you create later in this tutorial.
