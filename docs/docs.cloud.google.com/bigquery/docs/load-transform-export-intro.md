---
name: documents/docs.cloud.google.com/bigquery/docs/load-transform-export-intro
uri: https://docs.cloud.google.com/bigquery/docs/load-transform-export-intro
...
In the ELT data integration approach, you extract data from a data source and load it into BigQuery using any of the supported [methods of loading or accessing external data](https://docs.cloud.google.com/bigquery/docs/loading-data#methods) .
...
For more information, see [Introduction to transformations](https://docs.cloud.google.com/bigquery/docs/transform-intro) .
