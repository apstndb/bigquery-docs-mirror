---
name: documents/docs.cloud.google.com/bigquery/docs/create-machine-learning-model-console
uri: https://docs.cloud.google.com/bigquery/docs/create-machine-learning-model-console
title: Create an ML model in BigQuery ML by using the Google Cloud console
