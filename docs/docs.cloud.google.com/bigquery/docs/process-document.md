---
name: documents/docs.cloud.google.com/bigquery/docs/process-document
uri: https://docs.cloud.google.com/bigquery/docs/process-document
title: Process documents with the ML.PROCESS_DOCUMENT function
...
[Create a processor](https://docs.cloud.google.com/document-ai/docs/create-processor#create-processor) in Document AI to process the documents. The processor must be of a [supported type](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/bigqueryml-syntax-create-remote-model-service#document_processor) .
...
[Create an object table](https://docs.cloud.google.com/bigquery/docs/object-tables) over a set of documents in Cloud Storage. The documents in the object table must be of a [supported type](https://docs.cloud.google.com/document-ai/docs/file-types) .
