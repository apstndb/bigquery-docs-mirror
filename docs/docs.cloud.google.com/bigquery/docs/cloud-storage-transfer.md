---
name: documents/docs.cloud.google.com/bigquery/docs/cloud-storage-transfer
uri: https://docs.cloud.google.com/bigquery/docs/cloud-storage-transfer
...
If the transfer configuration is [runtime parameterized](https://docs.cloud.google.com/bigquery/docs/gcs-transfer-parameters) , you will need to specify a range of dates for which additional transfers will be started.
